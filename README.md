# Restaurant_app
# DOCUMENTATION  - Restaurant_app


## 1. Contexte du Projet

Ce projet, **Restaurant_app**, est une application web dont l'objectif est de fournir une API RESTful pour une plateforme de commande et de livraison de repas en ligne.
